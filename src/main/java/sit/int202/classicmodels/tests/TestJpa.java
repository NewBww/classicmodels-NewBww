...
public class TestJpa {
    ...
    private static final OfficeRepository repository =
    ...
    private static void addNewOffice() {
        ...
        newOffice.setCity("Bangkok");		newOffice.setCountry("Thailand");
        newOffice.setPostalCode("10140");		newOffice.setPhone("+66 2 470 9872");
        newOffice.setState("");			newOffice.setTerritory("SE-A");
